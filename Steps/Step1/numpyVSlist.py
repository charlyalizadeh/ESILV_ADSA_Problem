...
class NumpyVSList:
    ...
    def compute(self, operation):
        ...
        if operation == "init":
            return self.compute_time_init()
        elif operation == "reading":
            return self.compute_time_reading()
        elif operation == "writing":
            return self.compute_time_writing()

    def compute_time_init(self, nb_values=100, repeat=10000):
    ...
    def compute_time_reading(self, nb_values=100, repeat=10000):
    ...
    def compute_time_writing(self, nb_values=100, repeat=10000):
    ...
    def display_compare_init(self, nb_values=100, repeat=10000):
        ...
        time_numpy_array, time_core_list = self.compute_time_init(nb_values, repeat)
    ...
    def display_compare_reading(self, nb_values=100, repeat=10000):
        ...
        core_setup = "core_list = [i for i in range({})]".format(nb_values)
        core_test = "for i in core_list: pass"
        time_numpy_array, time_core_list = self.compute_time_reading(nb_values, repeat)
    ...
    def display_compare_writing(self, nb_values=100, repeat=10000):
        ...
        core_setup = "core_list = [i for i in range({})]".format(nb_values)
        core_test = "for i in range(len(core_list)): core_list[i] = 1"
        time_numpy_array, time_core_list = self.compute_time_writing(nb_values, repeat)
    ...
    def compare_all_plot(self, nb_values=100, repeat=10000):
